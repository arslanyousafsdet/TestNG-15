...
//    d.username= "Admin" ,password= ""  -->Error Message= "Password cannot be empty"
    ...
    public void invildDresentials(String username,String password,String errorMSG){
        driver.findElement(By.xpath("//input[@name='txtUsername']")).sendKeys(username);
        driver.findElement(By.xpath("//input[@id = 'txtPassword']")).sendKeys(password);
        driver.findElement(By.xpath("//input[@type='submit']")).click();

//       get the error message
        WebElement error = driver.findElement(By.xpath("WebElement error = driver.findElement(By.xpath(//span[@id='spanMessage']"));
